      ...
      <div className="container px-4 py-12 sm:px-6 lg:py-16">
        <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-4 text-gray-200">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              {[
                { name: "Birthday Parties", href: "/book-now" },
                { name: "Private Screenings", href: "/book-now" },
                { name: "Corporate Events", href: "/book-now" },
                { name: "Anniversary Celebrations", href: "/book-now" },
                { name: "Special Occasions", href: "/book-now" },
              ].map((item) => (
                <li key={item.name}>
                  <Link href={item.href} className="text-sm text-muted-foreground hover:text-primary">
                    {item.name}
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-muted-foreground">123 Cinema Street, Movie City, MC 12345</span>
              </li>
